...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = "SELECT dept AS department, COUNT(*) AS teacherCount FROM teacher GROUP BY dept";
    ...
    public void addStudentToClass() {
        ...
        String sql = "INSERT INTO course_student (course_id, student_id) VALUES (1, 123)";
